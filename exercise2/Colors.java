...
public class Colors {
   ...
   public static void main(final String args[]) {
       ...
       /*final List<String> str = Arrays.asList("bluebird", "red herring", "yellow bumblebee",
    "black spider", "green monkey","pink","great gatsby",
    "feeding frenzy","black bird","widowmaker","quran","bible","torah");*/
   //     }

   /* private Collection<String> str;

        List<String> result = str.stream().filter(s->s.startsWith("blue", "red", "yellow", "black", "green", "pink"))
    ...
    public static void main(String[] args) {
        ...
        code.colorful(new String[]{"bluebird","red herring", "yellow bumblebee",
                                    "black spider", "green monkey","pink","great gatsby",
                                    "feeding frenzy","black bird","widowmaker","quran","bible","torah"});
